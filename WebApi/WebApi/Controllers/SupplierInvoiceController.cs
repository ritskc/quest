...
namespace WebApi.Controllers
{
    ...
    public class SupplierInvoiceController : ControllerBase
    {
        ...
        public async Task<ActionResult<IEnumerable<SupplierInvoice>>> GetPos(int companyId,int warehouseId)
        {
            try
            {
                ...
                var result = await this.supplierInvoiceService.GetAllSupplierInvoicesAsync(companyId, warehouseId, userId);
